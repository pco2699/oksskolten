...
- **YouTube Videos as Text** — Videos become readable articles: the description box plus the caption transcript, grouped into timestamped paragraphs, instead of a scraped watch page. Captions are picked in your reading language where available, so summarization and search work on videos too
