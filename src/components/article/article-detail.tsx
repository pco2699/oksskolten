...
export function ArticleDetail({ articleUrl, enableZapNavigation = false }: ArticleDetailProps) {
  ...
  if (error) {
    return (
      <div className="max-w-4xl md:max-w-5xl mx-auto px-6 md:px-10 py-12 text-center">
  ...
  if (!article) {
    return (
      <div className="max-w-4xl md:max-w-5xl mx-auto px-6 md:px-10 py-8 space-y-4">
  ...
  return (
    <>
      ...
      <article ref={articleRef} className="article-card max-w-4xl md:max-w-5xl mx-auto px-6 md:px-10 py-8">
      {/* Title */}
